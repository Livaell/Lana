					...
					<div class="logoheader">
						...
						<span class="header1">
                        	...
                        	<div id="mylogo" style="display:block; width:150px; float:right; text-align:left" >
                            	...
                            	<div style="height:20px">(927) 925 16 54</div>
                            	<div style="height:20px">(927) 925 16 54</div>
                            </div>  
                      </h1>
					</div><!-- end logoheader -->
                  	<ul class="skiplinks">
                        <li style="float:left"><a href="#main" class="u2"><?php echo JText::_('TPL_BEEZ3_SKIP_TO_CONTENT'); ?></a></li>
						<li style="float:left"><a href="#nav" class="u2"><?php echo JText::_('TPL_BEEZ3_JUMP_TO_NAV'); ?></a></li>
							<?php if ($showRightColumn) : ?>
								<li style="float:left"><a href="#right" class="u2"><?php echo JText::_('TPL_BEEZ3_JUMP_TO_INFO'); ?></a></li>
							<?php endif; ?>
