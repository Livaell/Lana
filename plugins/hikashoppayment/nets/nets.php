...
class plgHikashoppaymentNets extends hikashopPaymentPlugin
{
	...
	function onAfterOrderConfirm(&$order, &$methods, $method_id) {
		...
		if( $this->payment_params->sandbox ) {
			$this->redirect_url = 'https://epayment-test.bbs.no/Terminal/default.aspx?merchantId='.$this->payment_params->merchant_id.'&transactionId='.$transactionId;
		} else {
			$this->redirect_url = 'https://epayment.bbs.no/Terminal/default.aspx?merchantId='.$this->payment_params->merchant_id.'&transactionId='.$transactionId;
		}
