...
?><div class="hikashop_bluepaid_end" id="hikashop_bluepaid_end">
	...
	<form id="hikashop_bluepaid_form" name="hikashop_bluepaid_form" action="<?php echo $urldestino;?>" method="post">
		...
		<?php
			...
			$doc->addScriptDeclaration("window.addEvent('domready', function() {document.getElementById('hikashop_bluepaid_form').submit();});");
