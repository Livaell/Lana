	...
	<td colspan="2">
		<table class="adminform" style="min-width:360px">
			<tbody>
				<tr>
					<th>
						<label for="check_information">
							<?php echo JText::_( 'CHECK_INFORMATION' ); ?>
						</label>
					</th>
				</tr>
				<tr>
					<td>
						<textarea rows="20" style="width:100%" name="check_information"><?php echo @$this->element->payment_params->information;?></textarea>						
					</td>
				</tr>
			</tbody>
		</table>
