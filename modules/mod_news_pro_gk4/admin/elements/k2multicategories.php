		...
		if (file_exists($path)) {
			...
			// Create a regular list.
			    ...
			    if($options[0]!=''){
	               ...
	               return '<select id="jform_params_k2_categories" style="display:none"></select><strong style="line-height: 2.6em">K2 is not installed or any K2 categories are available.</strong>';
	            }
			}
		} else {
			return '<select id="jform_params_k2_categories" style="display:none"></select><strong style="line-height: 2.6em">K2 is not installed or any K2 categories are available.</strong>';
