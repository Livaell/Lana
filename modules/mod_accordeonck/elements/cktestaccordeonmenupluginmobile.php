...
class JFormFieldCktestaccordeonmenupluginmobile extends JFormField {

    protected $type = 'cktestaccordeonmenupluginmobile';
    ...
    protected function getLabel() {
        ...
        if ((string) $this->element['hr'] == 'true') {
            ...
            $testpatch = $this->testPatch('accordeonmenumobileck');
    ...
    protected function testPatch($component) {
        if (JFile::exists(JPATH_ROOT . '/plugins/system/' . $component .'/'. $component . '.php')
            ...
            return JText::_('MOD_ACCORDEONCK_SPACER_' . strtoupper($component) . '_PATCH_INSTALLED');
        }
        return false;
    }
