...
?>		<div class="hika_edit">
			...
			<a href="<?php echo hikashop_completeLink($delete_url, true);?>" onclick="return window.addressMgr.delete(this,<?php echo $this->address_id; ?>,'<?php echo $uniq_id; ?>','<?php echo $this->type; ?>');"><img src="<?php echo HIKASHOP_IMAGES; ?>delete.png" alt=""/><span><?php echo JText::_('HIKA_DELETE'); ?></span></a>
		</div>
<?php
	} else {
?>		<div class="hika_edit">
...
if(JRequest::getVar('tmpl', '') == 'component') {
	...
	$miniFormat = $addressClass->miniFormat($this->address);
?>
