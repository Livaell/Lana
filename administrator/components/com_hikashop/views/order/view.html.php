...
class OrderViewOrder extends hikashopView{
	...
	function listing(){
		...
		$searchMap = array('c.id','c.username','c.name','a.user_email','b.order_user_id','b.order_number','b.order_id','b.order_invoice_number','b.order_invoice_id','b.order_full_price');
