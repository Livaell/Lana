...
?>				<table class="admintable table"  width="100%">
						...
						<tr class="hikashop_product_description_title_row">
							<td class="key">
						...
						<?php if($this->element->product_type=='main'){ ?>
							...
							<tr class="hikashop_product_canonical_row">
								...
								<td>
									<input type="text" id="product_canonial" name="<?php echo $this->product_canonical_input; ?>" value="<?php echo @$this->element->product_canonical; ?>"/>
