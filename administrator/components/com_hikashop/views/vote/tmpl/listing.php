...
<form action="index.php?option=<?php echo HIKASHOP_COMPONENT ?>&amp;ctrl=vote" method="post" name="adminForm" id="adminForm">
	<table>
		<tr>
			<td width="100%">
			...
			<td nowrap="nowrap">
				<select name="backend_listing_vote" id="ll" onChange="document.getElementById('backend_listing_vote').value= document.getElementById('ll').value; document.adminForm.submit();" size="1">
					<option value="both">Display</option>
					<option value="both">Vote & Comment</option>
	...
	<?php
		$backend_listing_vote = JRequest::getVar('backend_listing_vote', 'both', 'default', 'string', 0);
	?>
