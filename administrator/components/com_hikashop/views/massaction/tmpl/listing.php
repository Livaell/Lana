...
<form action="index.php?option=<?php echo HIKASHOP_COMPONENT ?>&amp;ctrl=massaction" method="post"  name="adminForm" id="adminForm">
	<table>
		<tr>
			<td width="100%">
			...
			<td nowrap="nowrap">
				<?php echo $this->tabletype->display('massaction_table',$this->selectedType); ?>
			</td>
		</tr>
	</table>
