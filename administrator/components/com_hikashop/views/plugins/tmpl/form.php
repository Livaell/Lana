...
?>
					...
					<tr>
						...
						?></td>
						<td><?php
							echo $this->currencies->display('data[payment][payment_currency][]', @$this->element->payment_currency, 'multiple="multiple" size="3"');
			if(!HIKASHOP_BACK_RESPONSIVE) {
						?><br/><a href="javascript:void(0)" onclick="selectNone('datapaymentpayment_currency');"><?php echo JText::_('HIKA_NO_RESCTION'); ?></a>
<?php
			}
?>
						</td>
