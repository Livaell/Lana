...
class hikashopVolumeType{
	...
	function display($map, $volume_unit,$type='dimension',$id=''){
		...
		if(!empty($id)){
			return JHTML::_('select.genericlist', $this->values, $map, 'class="inputbox volumeselect" size="1"', 'value', 'text', $volume_unit,$id);
		}else{
