...
class hikashopCategoryType{
	function load(){
		$this->values = array();
		$this->values[] = JHTML::_('select.option', 'product',JText::_('PRODUCT_CATEGORY') );
		$this->values[] = JHTML::_('select.option', 'tax',JText::_('TAXATION_CATEGORY'));
		$this->values[] = JHTML::_('select.option', 'status',JText::_('ORDER_STATUS'));
