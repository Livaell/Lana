...
?>				<tr>
				...
				<tr>
					...
					<td>
						<?php echo JHTML::_('hikaselect.booleanlist', "data[shipping][shipping_params][reverse_order]" , '',@$this->element->shipping_params->reverse_order ); ?>
					</td>
				</tr>
				<tr>
					<td class="key">
					...
					<td>
						...
						echo JHTML::_('hikaselect.booleanlist', "data[shipping][shipping_params][shipping_group]" , '',$this->element->shipping_params->shipping_group ); ?>
					</td>
				</tr>
