...
<tr>
	<td class="key">
		<label for="data[payment][payment_params][hide_login]">
			Hide login
		</label>
	</td>
	<td>
		<?php
		if(!isset($this->element->payment_params->hide_login)) $this->element->payment_params->hide_login=1;
		echo JHTML::_('hikaselect.booleanlist', "data[payment][payment_params][hide_login]" , '',$this->element->payment_params->hide_login	); ?>
	</td>
</tr>
<tr>
	<td class="key">
