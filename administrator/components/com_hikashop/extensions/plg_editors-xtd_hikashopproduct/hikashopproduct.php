...
class plgButtonHikashopproduct extends JPlugin
{
	...
	function productDisplay(){
		...
		$pageInfo->search = $app->getUserStateFromRequest( "search", 'search', '', 'string' );
...
?>
	<script language="JavaScript" type="text/javascript">
		...
		function checkSelect(){
			form = document.getElementById('adminForm_bottom');
	...
	<form action="<?php echo hikashop_currentURL();?>" method="post" name="adminForm_bottom" id="adminForm_bottom">
		<fieldset>
			...
			<table class="adminlist table table-striped" cellpadding="1" width="100%">
				...
				<tfoot>
					<tr>
						<td colspan="7">
							<?php $pagination->form = '_bottom'; echo $pagination->getListFooter(); ?>
						</td>
					</tr>
				</tfoot>
			</table>
