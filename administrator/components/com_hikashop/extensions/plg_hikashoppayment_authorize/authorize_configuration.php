...
<tr>
	<td class="key">
		<label for="data[payment][payment_params][capture]">
			<?php echo JText::_( 'INSTANTCAPTURE' ); ?>
		</label>
	</td>
	<td>
		<?php if(!isset($this->element->payment_params->capture))$this->element->payment_params->capture=1; ?>
...
<tr>
	...
	<td>
		...
		$values[] = JHTML::_('select.option', 'dpm',JText::_('DPM'));
