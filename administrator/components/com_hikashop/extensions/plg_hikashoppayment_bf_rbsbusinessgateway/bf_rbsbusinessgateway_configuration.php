...
<tr>
	...
	<td>
		<?php echo JHTML::_('hikaselect.booleanlist', "data[payment][payment_params][descProductName]" , '',@$this->element->payment_params->descProductName	); ?>
	</td>
</tr>
<tr>
	<td class="key">
...
<tr>
	...
	<td>
		<?php echo JHTML::_('hikaselect.booleanlist', "data[payment][payment_params][fixContact]" , '',@$this->element->payment_params->fixContact	); ?>
	</td>
</tr>
<tr>
	<td class="key">
	...
	<td>
		<?php echo JHTML::_('hikaselect.booleanlist', "data[payment][payment_params][hideContact]" , '',@$this->element->payment_params->hideContact	); ?>
	</td>
</tr>
<tr>
	<td class="key">
...
<tr>
	...
	<td>
		<?php echo JHTML::_('hikaselect.booleanlist', "data[payment][payment_params][testMode]" , '',@$this->element->payment_params->testMode	); ?>
	</td>
</tr>
<tr>
	<td class="key">
